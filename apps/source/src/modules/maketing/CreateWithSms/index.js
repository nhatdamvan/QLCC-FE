...
import CreateMarketingSmsForm from "./CreateMarketingSmsForm";
...
const CreateWithSms = () => {
  ...
  const getTemplates = async () => {
    postData(`smsTemplates`, infoViewActionsContext, {
      ValueFilter: "",
      Sort: { Name: 1 },
      PageIndex: 1,
      PageSize: 99,
              ...
              <Formik
                ...
                initialValues={{
                  ...
                  Code: detailMarketing?.Code
                    ...
                    : codeMarketing,
                  TypeCampaingnsCode: TypeCampaingnsCode.SMS,
                  TypeSourceDataCode: detailMarketing?.TypeSourceDataCode
                    ? detailMarketing?.TypeSourceDataCode
                    : typeSourceData[0]?.Code,
                  TempalteSMSId: detailMarketing?.TempalteSMSId
                    ? detailMarketing?.TempalteSMSId
                    : templates[0]?.id,
                  CustomerGroups: [],
                  Customers: [],
