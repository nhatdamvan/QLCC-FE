...
const TableItem = ({ data, onSelectContactsForDelete }) => {
  ...
  return (
    ...
    >
      ...
      <StyledTableCell align="left">{data.PhonenumberFirst}</StyledTableCell>
      <StyledTableCell align="left">{data.Email}</StyledTableCell>
      <StyledTableCell align="left">{data.SexName}</StyledTableCell>
      <StyledTableCell align="left">
        {moment(data.BirthDay).format("DD/MM/YYYY")}
      </StyledTableCell>
      <StyledTableCell align="left">{data.StatusCustomerName}</StyledTableCell>
