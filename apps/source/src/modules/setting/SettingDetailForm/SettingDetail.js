...
import { AiFillMail, AiFillFile } from 'react-icons/ai';
...
const SettingDetailForm = ({ values }) => {
    ...
    return (
        <Form noValidate autoComplete="off">
            ...
            <Box sx={{ height: "850px", minWidth: "260px", width: "100%", typography: "body1", padding: "16px", marginLeft: '10px' }}>
